...
class RFlagger(Flagger):
    ...
    #     print "??????", baselines
        ...
        #     print polarization
        #     filter_params = {'scan_number': scan_id, 'antenna1': antenna1, 'antenna2': antenna2}
        ...
        #
        #     another_antenna = antenna2 if base_antenna.id == antenna1 else antenna1
        #
        #     if base_antenna.id not in r_value_matrix.keys():
        #         r_value_matrix[base_antenna.id] = {}
        #     r_value_matrix[base_antenna.id].update({another_antenna: r_value})
        #
