...
class Flagger:
    ...
    def closure_based_bad_baselines(self):
        ...
        for polarization, scan_id in x:
            ...
            if len(good_antennas) > 1:
                ...
                good_antenna_tuple_list = self._find_first_good_antenna_tuple(antenna_ids, dd)
                if len(good_antenna_tuple_list) < 1:
                    print "No good antennas found"
    ...
    def _find_first_good_antenna_tuple(self, antenna_ids, dd):
        good_antennas = []
