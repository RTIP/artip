...
class FlaggingTest(unittest.TestCase):
    ...
    def __init__(self, dataset_name):
        ...
        config.load(self.seed_data_path + dataset_name + "/config.yml")

        self.ms_file = "{0}/{1}/{1}.ms".format(config.OUTPUT_PATH, dataset_name)
        fits_file = "{0}/{1}/{1}.fits".format(self.seed_data_path, dataset_name)
