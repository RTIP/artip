...
class ClosurePhaseUtilTest(TestCase):
    def test_should_closure_phase_of_given_triad_antennas_as_0(self):
        ...
        data = {'phase': numpy.array([[[[baseline_0_1_phase], [baseline_0_2_phase], [baseline_1_2_phase]]]]),
                'antenna1': antenna_1_list,
                'antenna2': antenna_2_list}

        closure_phase_util = ClosurePhaseUtil()

        expected_value = (baseline_0_1_phase + baseline_1_2_phase) - baseline_0_2_phase
        self.assertEqual(closure_phase_util.closurePhTriads((antenna_1, antenna_2, antenna_3), data), expected_value)
